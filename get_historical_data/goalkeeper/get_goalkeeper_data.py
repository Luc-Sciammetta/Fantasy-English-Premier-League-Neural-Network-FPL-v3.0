...
def cleanPlayerDataframe(df, fixturesdf, playerTeamID):
    ...
    saves_per_game_last_5 = [] #average number of saves per game in the last 5 games
    ...
    for index, _ in df.iterrows():
        ...
        saves_per_game_last_5.append(round(saves / games_played, 2) if games_played > 0 else 0)
...
def getFullDataset():
    ...
    for season in seasons:
        ...
        goalkeepers = active_players[active_players['element_type'] == 1] #only keep goalkeepers

        print("Looking at", len(goalkeepers), "players")

        for _, playerRow in goalkeepers.iterrows():
    ...
    final_df.to_csv('get_historical_data/goalkeeper/goalkeeper_data.csv', index=False)
