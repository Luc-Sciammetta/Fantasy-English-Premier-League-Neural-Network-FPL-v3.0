...
def getFullDataset():
    ...
    for season in seasons:
        ...
        forwards = active_players[active_players['element_type'] == 4] #only keep forwards

        print("Looking at", len(forwards), "players")

        for _, playerRow in forwards.iterrows():
    ...
    final_df.to_csv('get_historical_data/forward/forward_data.csv', index=False)
