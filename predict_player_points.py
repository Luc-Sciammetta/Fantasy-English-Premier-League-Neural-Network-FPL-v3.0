...
def predictPlayerNextGWPoints(player_id, current_gw):
    ...
    model.load_state_dict(torch.load('points_predictors/one_gw_1.560_best_model.pth'))
    scaler = joblib.load('points_predictors/one_gw_1.560_scaler.pkl')
...
print(predictPlayerNextGWPoints(16, 19)) 

# getPlayersFromAPI()
# getFixturesFromAPI()
# getPlayerStatFromAPI(5)
